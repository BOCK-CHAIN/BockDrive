...
const Hero = () => {
  ...
  return (
    <div className={`min-h-screen pr-6 pl-6 overflow-hidden ${isDarkMode ? 'dark bg-gray-900 text-white' : 'bg-white text-[#1E1919]'}`}>
      {/* Header */}
      ...
      {/* Hero Content */}
      <motion.div 
        className="container mx-auto px-6 pt-32 pb-20 flex flex-col lg:flex-row items-center gap-16"
      ...
      {/* Footer */}
      <footer className="bg-gray-50 dark:bg-gray-800/50 text-gray-600 dark:text-gray-400 py-16 
